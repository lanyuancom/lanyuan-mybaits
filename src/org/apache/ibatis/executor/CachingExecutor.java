...
public class CachingExecutor implements Executor {
	...
	public <E> List<E> query(MappedStatement ms, Object parameterObject,
		...
		if (cache != null) {
			...
			if (ms.isUseCache() && resultHandler == null) {
				...
				if (list == null) {
					...
					tcm.putObject(cache, key, list); // issue #578. Query must
														// be not synchronized
		...
		return delegate.<E> query(ms, parameterObject, rowBounds,
				resultHandler, key, boundSql);
	}
	...
	private void ensureNoOutParams(MappedStatement ms, Object parameter,
			BoundSql boundSql) {
